...
{
    public static string luaDir = Application.dataPath + "/LuaJIT/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/LuaJIT/ToLua/Lua";        //tolua lua文件目录
